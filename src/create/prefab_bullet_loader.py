...
def bullet_loader_from_file(bullet_path, level_path, mouse_pos, player_pos, player_size, bullet_type: str) -> dict:
    with open(bullet_path, "r") as bullet_file, open(level_path, "r") as level_file:
        ...
        return build_bullet_data(bullet_json, level_json, mouse_pos, player_pos, player_size, bullet_type)
